...
<head>
    ...
    <link rel="stylesheet" href="./css/startseitehotel.css">
...
echo'<section class = "rooms sec-width" id = "rooms">
    <div class = "title">
          <h2>Zimmer</h2>
            </div>
            <div class = "rooms-container">
                ...
                <article class = "room">
                    <div class = "room-image">
                        <img src = "images/slid6.jpg" alt = "room image">
                    </div>
                    <div class = "room-text">
                        <h3>Luxuszimmer</h3>
                        <ul>
                ...
                <article class = "room">
                    <div class = "room-image">
                        <img src = "images/hotel.jpg" alt = "room image">
                    </div>
                    <div class = "room-text">
                        <h3>Luxuszimmer</h3>
                        <ul>
                ...
                <article class = "room">
                    <div class = "room-image">
                        <img src = "images/zimm.jpg"  width="800px" alt = "room image">
                    </div>
                    <div class = "room-text">
                        <h3>Luxuszimmer</h3>
                        <ul>
