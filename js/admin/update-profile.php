...
if(isset($_POST['Submit']))
{
  ...
  $uid=intval($_GET['uid']);
$query=mysqli_query($con,"update users set geschlecht='$geschlecht', fname='$fname' ,lname='$lname' , contactno='$contact' where id='$uid'");
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <p class="centered"><a href="#"><img src="assets/img/fr-08.jpg" class="img-circle" width="60"></a></p>
                  ...
                  <div class="col-md-12">
                      ...
                      <p align="center" style="color:#F00;"><?php echo $_SESSION['msg'];?><?php echo $_SESSION['msg']=""; ?></p>
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="geschlecht" value="<?php echo $row['geschlecht'];?>" >
                              </div>
                              <br>
                              <br>
                              <hr>
