<?php include '../navi_inc_admin.php';?>
...
if($row>0)
{
	...
	$msg=mysqli_query($con,"insert into users(fname,lname,email,password,contactno,geschlecht) values('$fname','$lname','$email','$enc_password','$contact','$geschlecht')");
...
if($num>0)
{
	setcookie("type", $row["useremail"], time()+3600*60*60);
$extra="welcome.php";
$_SESSION['login']=$_POST['uemail'];
$_SESSION['id']=$num['id'];
$_SESSION['geschl']=$num['geschlecht'];
$_SESSION['name']=$num['fname'];
$_SESSION['sname']=$num['lname'];
$_SESSION['mail']=$num['email'];
$_SESSION['contact']=$num['contactno'];
$_SESSION['data']=$num['posting_date'];
...
<body>
<div class="main">
		<h1>Registrierungs- und Login-System</h1>
	 <div class="sap_tabs">	
			...
			<div class="resp-tabs-container">
					...
					<div class="facts">
						...
						<div class="register">
							...
							<p>Geschlecht *</p>
                             <select name="geschlecht" id="geschlecht" class="text" required>
                                <option value="" hidden>Geschlecht</option>
                                <option>Man</option>
                                <option>Frau</option>
                              </select>							
								<p>First Name </p>
